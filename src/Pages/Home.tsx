...
function Home() {
    return (
      ...
      <Container fluid className="image-container">
        <Row className="align-items-center" style={{ width: '100%', margin: '0' }}>
          <Col md={4} style={{ padding: '0' }}>
            <Image src="https://nehal276.github.io/nehals-project/homepageheadshot.png" fluid  className="my-image-class"/>
          </Col>
      ...
      <Carousel.Item>
        <ExampleCarouselImage src="https://nehal276.github.io/nehals-project/carouselimage2.png" altText="First slide" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <ExampleCarouselImage src="https://nehal276.github.io/nehals-project/carouselimage1.png" altText="First slide" />
        <Carousel.Caption >
      ...
      <Carousel.Item>
        <ExampleCarouselImage src="https://nehal276.github.io/nehals-project/carouselimage3.png" altText="First slide" />
        <Carousel.Caption>
          <h3>Ease-Aid</h3>
          <h6>
      ...
      <Carousel.Item>
        <ExampleCarouselImage src="https://nehal276.github.io/nehals-project/carouselimage4.png" altText="First slide" />
        <Carousel.Caption>
